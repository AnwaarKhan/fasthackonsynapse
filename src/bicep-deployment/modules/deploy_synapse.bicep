...
var storageRoleUniqueId = guid(resourceId('Microsoft.Storage/storageAccounts', synapseName), storageAccountName)
var storageRoleUserUniqueId = guid(resourceId('Microsoft.Storage/storageAccounts', synapseName), userObjectId)

output storageRoleUniqueIdOut string = storageRoleUniqueId
output storageRoleUserUniqueIdOut string = storageRoleUserUniqueId
